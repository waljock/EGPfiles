...
PROC SQL;
   ...
   SELECT t1.Material AS MAT_CD, 
          t1.'Material Description'n as MAT_DESC, 
          t1.'Package Description'n as PKG_DESC, 
          ifn(t1.'XM Hardware credit'n is missing, 0,t1.'XM Hardware credit'n) as XM_CREDIT, 
          ifn(t1.'Remote_BlueLink Costs'n is missing, 0, t1.'Remote_BlueLink Costs'n) as BL_COST, 
          ifn(t1.'Guidance_BlueLink Costs'n is missing,0, t1.'Guidance_BlueLink Costs'n) as BL_GUIDE_COST,
      ...
      FROM CARL.'xm_bluelink costs'n t1
	where t1.'Material Description'n is not missing;
quit;
