...
PROC SQL;
   ...
   SELECT DISTINCT t1.VEHICLE_KEY, 
		  ...
		  t1.CURRENT_REGION_CD as REGION_CD,
          t1.ACCESSORY_GROUP_CD, 
          t1.ManifestTot, 
...
PROC SQL;
   ...
   SELECT t1.VEHICLE_KEY, 
          ...
          t1.RDR_DATE, 
          t1.RDR_ENTRY_DATE, 
          t1.EXTERIOR_COLOR_CD, 
          t1.INTERIOR_COLOR_CD, 
          t2.GENERIC_COLOR_DESC, 
          t1.CURRENT_REGION_CD, 
          t1.INVENTORY_STATUS_CD, 
          t1.IS_HMFStdBC, 
          t3.IS_SALES_MONTH_END, 
          t3.SALES_DAY_OF_MONTH
      FROM WORK.FINAL_FINAL_FINAL_0_1 t1
           LEFT JOIN SALES.QM_TD_COLOR t2 ON (t1.PLANT_CD = t2.PLANT_CD) AND (t1.MODEL_CD = t2.MODEL_CD) AND 
          (t1.MODEL_YEAR = t2.MODEL_YEAR) AND (t1.EXTERIOR_COLOR_CD = t2.EXTERIOR_COLOR_CD) AND (t1.INTERIOR_COLOR_CD = 
